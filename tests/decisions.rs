...
fn buy_button_flag() {
    ...
    assert_decision!(flag_key, "user16", true, "primary");
    assert_decision!(flag_key, "user17", true, "warning");
    assert_decision!(flag_key, "user18", true, "danger");
    assert_decision!(flag_key, "user19", true, "success");
    assert_decision!(flag_key, "user20", true, "warning");
    assert_decision!(flag_key, "user21", true, "danger");
    assert_decision!(flag_key, "user22", true, "danger");
    assert_decision!(flag_key, "user23", true, "primary");
    assert_decision!(flag_key, "user24", true, "success");
    assert_decision!(flag_key, "user25", true, "success");
    assert_decision!(flag_key, "user26", true, "primary");
    assert_decision!(flag_key, "user27", true, "warning");
    assert_decision!(flag_key, "user28", true, "primary");
    assert_decision!(flag_key, "user29", true, "danger");
    assert_decision!(flag_key, "user30", true, "success");
    assert_decision!(flag_key, "user31", true, "primary");
}
